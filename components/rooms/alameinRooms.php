...
if (isset($_SESSION['admin_name'])){
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($validRoom && $validGuests && $validArrival && $validLeaving && $validNumber ) {
      ...
      $request = "INSERT INTO alamein_booking (room, guests, arrivals, leaving, user, number) VALUES ('$room', '$guests', '$arrivalDate', '$leavingDate', '$session', '$number')";
...
<section class="mainRooms">
  <div class="leftRooms">
    <div class="leftsRoomsA"></div>
      <div class="rightsRooms">
        <span class="right-t">Two Bedroom Apartment</span>
        This unit comes with enough space for an added comfort. Complete with a separate dining area, a fully-equipped kitchen and guest washroom for convenience. This Two Bedroom Apartment accommodates 4 adults and 2 children.
    </div>
  </div>
  <div class="rightRooms">
    <div class="rightsRooms2">
      <span class="right-t">Penthouse</span>
        A contemporary space with two terraces and a Jacuzzi. This massive unit gives ample space with an added luxurious feel. This unit comes with a spacious living area, dining area, a full kitchen and a maid's quarter. Accommodates 6 adults and 2 children
    </div>
    <div class="leftsRooms2A"></div>
  </div>
