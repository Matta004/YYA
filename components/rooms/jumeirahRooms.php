...
if (isset($_SESSION['admin_name'])){
  ...
  if (isset($_POST['submit'])) {
    ...
    if ($validRoom && $validGuests && $validArrival && $validLeaving && $validNumber ) {
      ...
      $request = "INSERT INTO jumeirah_booking (room, guests, arrivals, leaving, user, number) VALUES ('$room', '$guests', '$arrivalDate', '$leavingDate', '$session', '$number')";
